      ...
      <main className="flex min-h-0 flex-1 flex-col overflow-hidden xl:flex-row">
        <div className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
          <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <h1 className="font-serif text-2xl sm:text-3xl">Clientes</h1>
            <Link
        ...
        {selected && (
          <aside className="w-full shrink-0 overflow-y-auto border-t border-black/10 bg-white p-4 sm:p-5 xl:w-80 xl:border-l xl:border-t-0">
